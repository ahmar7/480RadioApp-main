    ...
    window.tram = (function (e) {
      ...
      var B = (function (t, n, r) {
          ...
          function g(F, j) {
            ...
            return (
              (gt.constructor = d),
              (d.mixin = function (st) {
                return (T[t] = d[t] = g(d, st)[t]), d;
              }),
              (d.open = function (st) {
                if (
                  ((D = {}),
                  i(st) ? (D = st.call(d, gt, rt, d, F)) : o(st) && (D = st),
                  o(D))
                )
                  for (var zt in D) n.call(D, zt) && (gt[zt] = D[zt]);
                return i(gt.init) || (gt.init = F), d;
              }),
              d.open(j)
            );
          }
      ...
      var u = (E.frame = (function () {
        ...
        y = B(function (t) {
          ...
          function F(x) {
            g.call(this, x), gt.call(this, x, zt, ge);
          }
          function j(x) {
          ...
          function D() {
            g.call(this), e.removeData(this.el, X), (this.$el = this.el = null);
          }
          function rt() {
            var x,
              $,
        ...
        f = B(function (t) {
          function n() {
            ...
            this.update("auto");
            var g = this.get();
            return this.update(a), g;
          }
          function r(a, g, F) {
            return g !== void 0 && (F = g), a in H ? a : F;
          }
          function o(a) {
            var g = /rgba?\((\d+),\s*(\d+),\s*(\d+)/.exec(a);
            return (g ? R(g[1], g[2], g[3]) : a).replace(
              /#(\w)(\w)(\w)$/,
              "#$1$1$2$2$3$3"
            );
          }
          var i = { duration: 500, ease: "ease", delay: 0 };
          (t.init = function (a, g, F, j) {
            ...
            F[2] && (d = F[2]),
              ...
              (this.name = d),
              (this.type = F[1]),
              (this.duration = U(g[1], this.duration, i.duration)),
              (this.ease = r(g[2], this.ease, i.ease)),
              (this.delay = U(g[3], this.delay, i.delay)),
        ...
        N = B(f, function (t, n) {
          ...
          (t.init = function () {
            ...
            (t.transition = function (o) {
              ...
              var a,
                g = {};
              for (a in this.current) g[a] = a in i ? i[a] : this.current[a];
            ...
            (t.values = function (o) {
              var i,
                a = {};
              return (
                r.call(this, o, function (g, F, j) {
                  (a[g] = F),
                    this.current[g] === void 0 &&
                      ((i = 0),
                      ~g.indexOf("scale") && (i = 1),
                      (this.current[g] = this.convert(i, j)));
                }),
                a
              );
            });
        ...
        L = B(function (t) {
          ...
          var g = { ease: H.ease[1], from: 0, to: 1 };
          (t.init = function (d) {
            (this.duration = d.duration || 0), (this.delay = d.delay || 0);
            var T = d.ease || g.ease;
            H[T] && (T = H[T][1]),
              typeof T != "function" && (T = g.ease),
              (this.ease = T),
          ...
          (t.init = function (r) {
            ...
            (t.render = function (r) {
              ...
              for (o = a; o--; )
                (i = this.tweens[o]),
                  i.context &&
                    (i.render(r), (this.current[i.name] = i.value), (g = !0));
              return g
      ...
      var E = {},
        ...
        K =
          ...
          e.forEach =
            function (s, c, w) {
              if (s == null) return s;
              if (nt && s.forEach === nt) s.forEach(c, w);
              else if (s.length === +s.length) {
                for (var h = 0, z = s.length; h < z; h++)
                  if (c.call(w, s[h], h, s) === E) return;
              } else
                for (var O = e.keys(s), h = 0, z = O.length; h < z; h++)
                  if (c.call(w, s[O[h]], O[h], s) === E) return;
              return s;
            });
      (e.map = e.collect =
        function (s, c, w) {
        ...
        (e.find = e.detect =
          function (s, c, w) {
            ...
            return (
              at(s, function (z, O, u) {
                if (c.call(w, z, O, u)) return (h = z), !0;
              }),
              h
            );
          }),
        ...
        e.any =
          function (s, c, w) {
            ...
            return s == null
              ...
              ? s.some(c, w)
              : (K(s, function (z, O, u) {
                  if (h || (h = c.call(w, z, O, u))) return E;
                }),
                !!h);
          });
        ...
        (e.debounce = function (s, c, w) {
          var h,
            ...
            y = function () {
              ...
              l < c
                ? (h = setTimeout(y, c - l))
                : ((h = null), w || ((m = s.apply(O, z)), (O = z = null)));
            };
          return function () {
    ...
    Xt.define(
      ...
      (me.exports = function (e, E) {
        ...
        function v(u, m) {
          ...
          var f = y.closest("div.input-form");
          (l.done = f.find("> .input-form-done")),
            (l.fail = f.find("> .input-form-fail")),
        ...
        function h(u, m) {
          ...
          function n(i, a) {
            ...
            var g = a.fileName,
              ...
              j = a.fileId,
              d = a.s3Url;
            L.attr("data-value", j), O(d, F, y, g, r);
          }
          function r(i) {
            if (i) return t(i);
            A.toggle(!1),
